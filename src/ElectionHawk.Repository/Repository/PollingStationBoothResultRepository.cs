...
namespace ElectionHawk.Repository
{
    ...
    public class PollingStationBoothResultRepository:RepositoryBase, IPollingStationBoothResultRepository
    {
        public PollingStationBoothResultRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.PollingStationBoothResultEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.PollingStationBoothResultEntity>(new entity.PollingStationBoothResultEntity { PollingBoothResultId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.PollingStationBoothResultEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.PollingStationBoothResultEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.PollingStationBoothResultEntity>(new entity.PollingStationBoothResultEntity { PollingBoothResultId = id });
                }
            }
            catch (Exception ex)
            {
