...
namespace ElectionHawk.Repository
{
    ...
    public class PartyOfficeRepository:RepositoryBase , IPartyOfficeRepository
    {
        public PartyOfficeRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.PartyOfficeEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.PartyOfficeEntity>(new entity.PartyOfficeEntity { PartyOfficeId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.PartyOfficeEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.PartyOfficeEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.PartyOfficeEntity>(new entity.PartyOfficeEntity { PartyOfficeId = id });
                }
            }
            catch (Exception ex)
            {
