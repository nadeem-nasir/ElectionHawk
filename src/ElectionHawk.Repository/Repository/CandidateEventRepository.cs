...
namespace ElectionHawk.Repository
{
    ...
    public class CandidateEventRepository : RepositoryBase, ICandidateEventRepository
    {
       public CandidateEventRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.CandidateEventEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.CandidateEventEntity>(new entity.CandidateEventEntity { CandidateEventId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.CandidateEventEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.CandidateEventEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.CandidateEventEntity>(new entity.CandidateEventEntity { CandidateEventId = id });
                }
            }
            catch (Exception ex)
            {
