...
namespace ElectionHawk.Repository
{
    ...
    public class ProfileTypeRepository : RepositoryBase, IProfileTypeRepository
    {
        public ProfileTypeRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.ProfileTypeEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.ProfileTypeEntity>(new entity.ProfileTypeEntity { ProfileTypeId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.ProfileTypeEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.ProfileTypeEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.ProfileTypeEntity>(new entity.ProfileTypeEntity { ProfileTypeId = id });
                }
            }
            catch (Exception ex)
            {
