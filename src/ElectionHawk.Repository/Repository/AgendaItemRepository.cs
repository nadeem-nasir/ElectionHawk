...
namespace ElectionHawk.Repository
{
    ...
    public class AgendaItemRepository : RepositoryBase, IAgendaItemRepository
    {
        public AgendaItemRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.AgendaItemEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.AgendaItemEntity>(new entity.AgendaItemEntity { ItemId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.AgendaItemEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.AgendaItemEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.AgendaItemEntity>(new entity.AgendaItemEntity { ItemId = id });
                }
            }
            catch (Exception ex)
            {
