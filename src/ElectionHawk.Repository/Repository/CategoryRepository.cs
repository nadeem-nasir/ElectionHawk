...
namespace ElectionHawk.Repository
{
    ...
    {
       public CategoryRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.CategoryEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.CategoryEntity>(new entity.CategoryEntity { CategoryId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.CategoryEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.CategoryEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.CategoryEntity>(new entity.CategoryEntity { CategoryId = id });
                }
            }
            catch (Exception ex)
            {
