...
namespace ElectionHawk.Repository
{
    ...
    public class ConstituencyVoterListRepository : RepositoryBase, IConstituencyVoterListRepository
    {
        public ConstituencyVoterListRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.ConstituencyVoterListEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.ConstituencyVoterListEntity>(new entity.ConstituencyVoterListEntity { ConstituencyId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.ConstituencyVoterListEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.ConstituencyVoterListEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.ConstituencyVoterListEntity>(new entity.ConstituencyVoterListEntity { ConstituencyId = id });
                }
            }
            catch (Exception ex)
            {
