...
namespace ElectionHawk.Repository
{
    ...
    {
        public TaskRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.TaskEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.TaskEntity>(new entity.TaskEntity { TaskId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.TaskEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.TaskEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.TaskEntity>(new entity.TaskEntity { TaskId = id });
                }
            }
            catch (Exception ex)
            {
