...
namespace ElectionHawk.Repository
{
    ...
    public class SMSCampaignRepository : RepositoryBase, ISMSCampaignRepository
    {
        public SMSCampaignRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.SMSCampaignEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.SMSCampaignEntity>(new entity.SMSCampaignEntity { SMSCampaignId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.SMSCampaignEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.SMSCampaignEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.SMSCampaignEntity>(new entity.SMSCampaignEntity { SMSCampaignId = id });
                }
            }
            catch (Exception ex)
            {
