...
namespace ElectionHawk.Repository
{
    ...
    public class ElectionTypeRepository : RepositoryBase, IElectionTypeRepository

    {
        public ElectionTypeRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.ElectionTypeEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.ElectionTypeEntity>(new entity.ElectionTypeEntity { ElectionTypeId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.ElectionTypeEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.ElectionTypeEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.ElectionTypeEntity>(new entity.ElectionTypeEntity { ElectionTypeId = id });
                }
            }
            catch (Exception ex)
            {
