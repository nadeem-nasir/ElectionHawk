...
namespace ElectionHawk.Repository
{
    ...
    public class PoliticalPartyDesignationRepository:RepositoryBase, IPoliticalPartyDesignationRepository
    {
        public PoliticalPartyDesignationRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.PoliticalPartyDesignationEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.PoliticalPartyDesignationEntity>(new entity.PoliticalPartyDesignationEntity { DesignationId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.PoliticalPartyDesignationEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.PoliticalPartyDesignationEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.PoliticalPartyDesignationEntity>(new entity.PoliticalPartyDesignationEntity { DesignationId = id });
                }
            }
            catch (Exception ex)
            {
