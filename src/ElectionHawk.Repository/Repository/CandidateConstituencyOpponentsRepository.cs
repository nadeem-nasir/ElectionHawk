...
namespace ElectionHawk.Repository
{
    ...
    public class CandidateConstituencyOpponentsRepository : RepositoryBase, ICandidateConstituencyOpponentsRepository
    {
        public CandidateConstituencyOpponentsRepository(ConnectionString connectionString) : base(connectionString) { }
        ...
        public async Task<entity.CandidateConstituencyOpponentsEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.CandidateConstituencyOpponentsEntity>(new entity.CandidateConstituencyOpponentsEntity { OpponentProfileId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.CandidateConstituencyOpponentsEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.CandidateConstituencyOpponentsEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.CandidateConstituencyOpponentsEntity>(new entity.CandidateConstituencyOpponentsEntity { OpponentProfileId = id });
                }
            }
            catch (Exception ex)
            {
