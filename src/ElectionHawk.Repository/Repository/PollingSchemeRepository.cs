...
namespace ElectionHawk.Repository
{
    ...
    public class PollingSchemeRepository:RepositoryBase, IPollingSchemeRepository
    {
       public PollingSchemeRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.PollingSchemeEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.PollingSchemeEntity>(new entity.PollingSchemeEntity { PollingSchemeId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.PollingSchemeEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.PollingSchemeEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.PollingSchemeEntity>(new entity.PollingSchemeEntity { PollingSchemeId = id });
                }
            }
            catch (Exception ex)
            {
