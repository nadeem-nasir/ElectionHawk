...
namespace ElectionHawk.Repository
{
    ...
    public  class CandidateConstituencyRepository : RepositoryBase, ICandidateConstituencyRepository
    {
       public CandidateConstituencyRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.CandidateConstituencyEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.CandidateConstituencyEntity>(new entity.CandidateConstituencyEntity { ConstituencyId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.CandidateConstituencyEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.CandidateConstituencyEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.CandidateConstituencyEntity>(new entity.CandidateConstituencyEntity { ConstituencyId = id });
                }
            }
            catch (Exception ex)
            {
