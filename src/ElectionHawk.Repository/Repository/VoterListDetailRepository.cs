...
namespace ElectionHawk.Repository
{
    ...
    public class VoterListDetailRepository : RepositoryBase, IVoterListDetailRepository
    {
        public VoterListDetailRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.VoterListDetailEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.VoterListDetailEntity>(new entity.VoterListDetailEntity { VoterListId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.VoterListDetailEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.VoterListDetailEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.VoterListDetailEntity>(new entity.VoterListDetailEntity { VoterListId = id });
                }
            }
            catch (Exception ex)
            {
