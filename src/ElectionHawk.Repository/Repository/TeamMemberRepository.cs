...
namespace ElectionHawk.Repository
{
    ...
    {
        public TeamMemberRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.TeamMemberEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.TeamMemberEntity>(new entity.TeamMemberEntity { TeamId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.TeamMemberEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.TeamMemberEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.TeamMemberEntity>(new entity.TeamMemberEntity { TeamId = id });
                }
            }
            catch (Exception ex)
            {
