...
namespace ElectionHawk.Repository
{
    ...
    {
       public NotificationRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.NotificationEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.NotificationEntity>(new entity.NotificationEntity { NotificationId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.NotificationEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.NotificationEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.NotificationEntity>(new entity.NotificationEntity { NotificationId = id });
                }
            }
            catch (Exception ex)
            {
