...
namespace ElectionHawk.Repository
{
    ...
    public class TargetCommunityRepository : RepositoryBase, ITargetCommunityRepository
    {
        public TargetCommunityRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.TargetCommunityEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.TargetCommunityEntity>(new entity.TargetCommunityEntity { CommunityId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.TargetCommunityEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.TargetCommunityEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.TargetCommunityEntity>(new entity.TargetCommunityEntity { CommunityId = id });
                }
            }
            catch (Exception ex)
            {
