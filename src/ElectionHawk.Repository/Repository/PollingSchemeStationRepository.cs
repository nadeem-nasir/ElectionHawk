...
namespace ElectionHawk.Repository
{
    ...
    public class PollingSchemeStationRepository : RepositoryBase, IPollingSchemeStationRepository
    {
       public PollingSchemeStationRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.PollingSchemeStationEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.PollingSchemeStationEntity>(new entity.PollingSchemeStationEntity { StationId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.PollingSchemeStationEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.PollingSchemeStationEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.PollingSchemeStationEntity>(new entity.PollingSchemeStationEntity { StationId = id });
                }
            }
            catch (Exception ex)
            {
