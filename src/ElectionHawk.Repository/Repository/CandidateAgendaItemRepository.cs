...
namespace ElectionHawk.Repository
{
    ...
    public class CandidateAgendaItemRepository : RepositoryBase, ICandidateAgendaItemRepository
    {
       public CandidateAgendaItemRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.CandidateAgendaItemEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.CandidateAgendaItemEntity>(new entity.CandidateAgendaItemEntity { AgendaId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.CandidateAgendaItemEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.CandidateAgendaItemEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.CandidateAgendaItemEntity>(new entity.CandidateAgendaItemEntity { AgendaId = id });
                }
            }
            catch (Exception ex)
            {
