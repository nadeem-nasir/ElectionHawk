...
namespace ElectionHawk.Repository
{
    ...
    public class ProvinceRepository : RepositoryBase, IProvinceRepository
    {
        ...
        public async Task<entity.ProvinceEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.ProvinceEntity>(new entity.ProvinceEntity { ProvinceId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.ProvinceEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.ProvinceEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.ProvinceEntity>(new entity.ProvinceEntity { ProvinceId = id });
                }
            }
            catch (Exception ex)
            {
