...
namespace ElectionHawk.Repository
{
    ...
    {
        public ProfileRepository(ConnectionString connectionString) : base(connectionString) { }
        #region Get and Find 
        ...
        public async Task<entity.ProfileEntity> GetByIdAsync(int id)
        {
            ...
            {
                connection.Open();
                return await connection.GetAsync<entity.ProfileEntity>(new entity.ProfileEntity { ProfileId = id });
            }
        }
        /// <summary>
        /// get all 
        ...
        public async Task<IEnumerable<entity.ProfileEntity>> GetAllAsync()
        {
            ...
            {
                connection.Open();
                return await connection.FindAsync<entity.ProfileEntity>();
            }
        }
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    return await connection.DeleteAsync<entity.ProfileEntity>(new entity.ProfileEntity { ProfileId = id });
                }
            }
            catch (Exception ex)
            {
