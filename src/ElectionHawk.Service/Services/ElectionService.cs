...
namespace ElectionHawk.Service
{
    public class ElectionService : ServiceBase, IElectionService
    {
        ...
        {
            return await this._electionRepository.GetByIdAsync(id);
        }
        /// <summary>
        /// get all 
        /// </summary>
        ...
        {
            return await this._electionRepository.GetAllAsync();
        ...
        public async Task<int?> InsertAsync(entity.ElectionEntity entityToInsert)
        {
            try
            {
                await this._electionRepository.InsertAsync(entityToInsert);
        ...
        public async Task<bool> UpdateAsync(entity.ElectionEntity entityToUpdate)
        {
            try
            {
                return await this._electionRepository.UpdateAsync(entityToUpdate);
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                return await this._electionRepository.DeleteByIdAsync(id);
            }
            catch (Exception ex)
            {
                throw ex;
