...
namespace ElectionHawk.Service
{
    public class ExpenseService : ServiceBase, IExpenseService
    {
        ...
        {
            return await this._expenseRepository.GetByIdAsync(id);
        }
        /// <summary>
        /// get all 
        /// </summary>
        ...
        {
            return await this._expenseRepository.GetAllAsync();
        ...
        public async Task<int?> InsertAsync(entity.ExpenseEntity entityToInsert)
        {
            try
            {
                await this._expenseRepository.InsertAsync(entityToInsert);
        ...
        public async Task<bool> UpdateAsync(entity.ExpenseEntity entityToUpdate)
        {
            try
            {
                return await this._expenseRepository.UpdateAsync(entityToUpdate);
        ...
        public async Task<bool> DeleteByIdAsync(int id)
        {
            try
            {
                return await this._expenseRepository.DeleteByIdAsync(id);
            }
            catch (Exception ex)
            {
                throw ex;
