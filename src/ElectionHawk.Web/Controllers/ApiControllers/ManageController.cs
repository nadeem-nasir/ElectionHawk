...
using ElectionHawk.Web.ViewModels.ManageViewModels;
...
namespace ElectionHawk.Web.Controllers.ApiControllers
{
    ...
    {
        private readonly ElectionHawkIdentityContext _context;
        ...
        ElectionHawkIdentityContext context,
        ...
        public IActionResult UserPhoto()
        {
            ...
            var profilePictureUrl = string.Format("data:{0};base64,{1}", profileImage.ContentType, System.Convert.ToBase64String(profileImage.Content));
            //Convert.ToBase64String(profileImage.Content)
            return new ObjectResult(profilePictureUrl);
        }
