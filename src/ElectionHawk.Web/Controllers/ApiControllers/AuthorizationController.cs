    ...
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize(OpenIdConnectRequest request)
        {
            ...
            else
            {
                ...
                {
                    var user = new ElectionHawkIdentityUser { UserName = email, Email = email };
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync(OpenIdConnectRequest request, ElectionHawkIdentityUser user, AuthenticationProperties properties = null)
        {
